...
class CertificateListItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * @return $this
     */
    public function setSubjectIdentifier(string $subject_identifier): static
    {
     ...
     * @return string
     */
    public function getSubjectIdentifierType(): string
    {
     ...
     * @return $this
     */
    public function setSubjectIdentifierType(string $subject_identifier_type): static
    {
