...
class PublicKeyCertificate implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @return string[]
     */
    public static function getUsageAllowableValues()
    {
        return [
    ...
    */
     ...
     * @return $this
     */
    public function setCertificatePem(?string $certificate_pem): static
    {
    ...
    public function setUsage(array $usage): static
    {
        ...
        $allowedValues = self::getUsageAllowableValues();
