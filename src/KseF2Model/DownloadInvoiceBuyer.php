...
/**
 * DownloadInvoiceBuyer Class Doc Comment
 *
 * @package  NetSeven
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DownloadInvoiceBuyer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DownloadInvoiceBuyer';
    ...
    protected static array $openAPITypes = [
        'identifier_type' => '\NetSeven\KseF2Model\BuyerIdentifierType',
        'identifier' => 'string',
        'name' => 'string'
    ];
    ...
    */
     ...
     */
    public function getIdentifierType(): \NetSeven\KseF2Model\BuyerIdentifierType
    {
     ...
     *
     * @param \NetSeven\KseF2Model\BuyerIdentifierType $identifier_type Typ identyfikatora nabywcy.
     *
     * @return $this
     */
    public function setIdentifierType(\NetSeven\KseF2Model\BuyerIdentifierType $identifier_type): static
    {
     ...
     * Sets identifier
     *
     * @param string|null $identifier Wartośc identyfikatora nabywcy. Wymagane jeśli IdentifierType != 'None'.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name Nazwa podmiotu nabywcy, jeśli występuje na fakturze.
     *
     * @return $this
     */
