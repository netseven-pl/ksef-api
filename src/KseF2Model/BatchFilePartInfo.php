...
class BatchFilePartInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets file_name
     *
     * @param string $file_name Nazwa części pliku paczki.
     *
     * @return $this
     */
     ...
     * Sets file_size
     *
     * @param int $file_size Rozmiar części pliku paczki.
     *
     * @return $this
     */
     ...
     * Sets file_hash
     *
     * @param string $file_hash Skrót SHA256 części pliku paczki, zakodowany w formacie Base64.
     *
     * @return $this
     */
