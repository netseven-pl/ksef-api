...
class PartUploadRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets ordinal_number
     *
     * @param int|null $ordinal_number Numer sekwencyjny części pliku paczki.
     *
     * @return $this
     */
     ...
     * Sets method
     *
     * @param string|null $method Metoda HTTP, której należy użyć przy wysyłce części pliku paczki.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string|null $url Adres pod który należy wysłać część pliku paczki.
     *
     * @return $this
     */
     ...
     * Sets headers
     *
     * @param array<string,string>|null $headers Nagłówki, których należy użyć przy wysyłce części pliku paczki.
     *
     * @return $this
     */
