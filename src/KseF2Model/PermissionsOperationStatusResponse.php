...
class PermissionsOperationStatusResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param \NetSeven\KseF2Model\StatusInfo $status Informacje o aktualnym statusie.  | Code | Description | Details |  | --- | --- | --- |  | 100 | Operacja przyjęta do realizacji | - |  | 200 | Operacja zakończona sukcesem | - |  | 400 | Operacja zakończona niepowodzeniem | - |  | 500 | Nieznany błąd | - |
     *
     * @return $this
     */
