...
class StatusWysykiIUPOApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \NetSeven\KseF2Model\InvoiceStatusResponse|\NetSeven\KseF2Model\ExceptionResponse
     */
    ...
    ): \NetSeven\KseF2Model\InvoiceStatusResponse|\NetSeven\KseF2Model\ExceptionResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \NetSeven\KseF2Model\InvoiceStatusResponse|\NetSeven\KseF2Model\ExceptionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NetSeven\KseF2Model\InvoiceStatusResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\NetSeven\KseF2Model\InvoiceStatusResponse';
        $request = $this->apiV2SessionsReferenceNumberInvoicesInvoiceReferenceNumberGetRequest($reference_number, $invoice_reference_number, $contentType);
