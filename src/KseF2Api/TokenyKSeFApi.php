...
class TokenyKSeFApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \NetSeven\KseF2Model\AuthenticationToken|\NetSeven\KseF2Model\ExceptionResponse
     */
    public function apiV2TokensReferenceNumberGet(
        string $reference_number,
        string $contentType = self::contentTypes['apiV2TokensReferenceNumberGet'][0]
    ): \NetSeven\KseF2Model\AuthenticationToken|\NetSeven\KseF2Model\ExceptionResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \NetSeven\KseF2Model\AuthenticationToken|\NetSeven\KseF2Model\ExceptionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NetSeven\KseF2Model\AuthenticationToken',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\NetSeven\KseF2Model\AuthenticationToken';
        $request = $this->apiV2TokensReferenceNumberGetRequest($reference_number, $contentType);
