...
class AuthenticationTokenRefreshResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticationTokenRefreshResponse';
    ...
    */
     ...
     * Sets access_token
     *
     * @param \OpenAPI\Client\Model\TokenInfo $access_token Token dostępu, którego należy używać w wywołaniach chronionych zasobów API.
     *
     * @return self
     */
