...
class GenerateTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $reference_number Numer referencyjny tokena KSeF. Za jego pomocą można sprawdzić jego status lub go unieważnić.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Token KSeF.
     *
     * @return self
     */
