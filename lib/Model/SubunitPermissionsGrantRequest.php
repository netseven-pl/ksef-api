...
class SubunitPermissionsGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubunitPermissionsGrantRequest';
    ...
    protected static $openAPITypes = [
        'subject_identifier' => '\OpenAPI\Client\Model\SubunitPermissionsSubjectIdentifier',
        'context_identifier' => '\OpenAPI\Client\Model\SubunitPermissionsContextIdentifier',
        'description' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\SubunitPermissionsSubjectIdentifier
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SubunitPermissionsSubjectIdentifier $subject_identifier Identyfikator podmiotu lub osoby fizycznej.  | Type | Value |  | --- | --- |  | Nip | 10 cyfrowy numer NIP |  | Pesel | 11 cyfrowy numer PESEL |  | Fingerprint | Odcisk palca certyfikatu |
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\SubunitPermissionsContextIdentifier
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SubunitPermissionsContextIdentifier $context_identifier Identyfikator podmiotu podrzędnego.  | Type | Value |  | --- | --- |  | Nip | 10 cyfrowy numer NIP |  | InternalId | Dwuczłonowy identyfikator składający się z numeru NIP i 5 cyfr: `{nip}-{5_cyfr}` |
     *
     * @return self
     */
