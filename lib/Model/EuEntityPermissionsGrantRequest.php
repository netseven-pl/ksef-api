...
class EuEntityPermissionsGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EuEntityPermissionsGrantRequest';
    ...
    protected static $openAPITypes = [
        'subject_identifier' => '\OpenAPI\Client\Model\EuEntityPermissionsSubjectIdentifier',
        'permissions' => '\OpenAPI\Client\Model\EuEntityPermissionType[]',
        'description' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\EuEntityPermissionsSubjectIdentifier
     */
     ...
     *
     * @param \OpenAPI\Client\Model\EuEntityPermissionsSubjectIdentifier $subject_identifier Identyfikator podmiotu.  | Type | Value |  | --- | --- |  | Fingerprint | Odcisk palca certyfikatu |
     *
     * @return self
     */
     ...
     * Gets permissions
     *
     * @return \OpenAPI\Client\Model\EuEntityPermissionType[]
     */
     ...
     * Sets permissions
     *
     * @param \OpenAPI\Client\Model\EuEntityPermissionType[] $permissions Lista nadawanych uprawnień. Każda wartość może wystąpić tylko raz.
     *
     * @return self
     */
