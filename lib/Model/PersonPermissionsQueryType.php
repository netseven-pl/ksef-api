 ...
 * @link     https://openapi-generator.tech
 */
class PersonPermissionsQueryType
{
    /**
     * Possible values of this enum
     */
    public const PERMISSIONS_IN_CURRENT_CONTEXT = 'PermissionsInCurrentContext';

    public const PERMISSIONS_GRANTED_IN_CURRENT_CONTEXT = 'PermissionsGrantedInCurrentContext';
    ...
    {
        return [
            self::PERMISSIONS_IN_CURRENT_CONTEXT,
            self::PERMISSIONS_GRANTED_IN_CURRENT_CONTEXT
        ];
    }
}
