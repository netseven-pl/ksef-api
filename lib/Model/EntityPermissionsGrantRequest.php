...
class EntityPermissionsGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityPermissionsGrantRequest';
    ...
    protected static $openAPITypes = [
        'subject_identifier' => '\OpenAPI\Client\Model\EntityPermissionsSubjectIdentifier',
        'permissions' => '\OpenAPI\Client\Model\EntityPermission[]',
        'description' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\EntityPermissionsSubjectIdentifier
     */
     ...
     *
     * @param \OpenAPI\Client\Model\EntityPermissionsSubjectIdentifier $subject_identifier Identyfikator podmiotu.  | Type | Value |  | --- | --- |  | Nip | 10 cyfrowy numer NIP |
     *
     * @return self
     */
     ...
     * Gets permissions
     *
     * @return \OpenAPI\Client\Model\EntityPermission[]
     */
     ...
     * Sets permissions
     *
     * @param \OpenAPI\Client\Model\EntityPermission[] $permissions Lista nadawanych uprawnień. Każda wartość może wystąpić tylko raz.
     *
     * @return self
     */
