...
class EntityAuthorizationPermissionsGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityAuthorizationPermissionsGrantRequest';
    ...
    protected static $openAPITypes = [
        'subject_identifier' => '\OpenAPI\Client\Model\EntityAuthorizationPermissionsSubjectIdentifier',
        'permission' => '\OpenAPI\Client\Model\EntityAuthorizationPermissionType',
        'description' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\EntityAuthorizationPermissionsSubjectIdentifier
     */
     ...
     *
     * @param \OpenAPI\Client\Model\EntityAuthorizationPermissionsSubjectIdentifier $subject_identifier Identyfikator podmiotu.  | Type | Value |  | --- | --- |  | Nip | 10 cyfrowy numer NIP |
     *
     * @return self
     */
     ...
     * Gets permission
     *
     * @return \OpenAPI\Client\Model\EntityAuthorizationPermissionType
     */
     ...
     * Sets permission
     *
     * @param \OpenAPI\Client\Model\EntityAuthorizationPermissionType $permission Nadawane uprawnienie o charakterze upoważnienia.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Opis nadawanego uprawnienia.
     *
     * @return self
     */
