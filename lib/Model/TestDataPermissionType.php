 ...
 * @link     https://openapi-generator.tech
 */
class TestDataPermissionType
{
    /**
     * Possible values of this enum
     */
    public const INVOICE_READ = 'InvoiceRead';

    public const INVOICE_WRITE = 'InvoiceWrite';

    public const INTROSPECTION = 'Introspection';

    public const CREDENTIALS_READ = 'CredentialsRead';

    public const CREDENTIALS_MANAGE = 'CredentialsManage';

    public const ENFORCEMENT_OPERATIONS = 'EnforcementOperations';

    public const SUBUNIT_MANAGE = 'SubunitManage';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::CREDENTIALS_MANAGE,
            self::ENFORCEMENT_OPERATIONS,
            self::SUBUNIT_MANAGE
        ];
    }
}
