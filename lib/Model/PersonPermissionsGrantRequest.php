...
class PersonPermissionsGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonPermissionsGrantRequest';
    ...
    protected static $openAPITypes = [
        'subject_identifier' => '\OpenAPI\Client\Model\PersonPermissionsSubjectIdentifier',
        'permissions' => '\OpenAPI\Client\Model\PersonPermissionType[]',
        'description' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\PersonPermissionsSubjectIdentifier
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PersonPermissionsSubjectIdentifier $subject_identifier Identyfikator osoby fizycznej.  | Type | Value |  | --- | --- |  | Nip | 10 cyfrowy numer NIP |  | Pesel | 11 cyfrowy numer PESEL |  | Fingerprint | Odcisk palca certyfikatu |
     *
     * @return self
     */
     ...
     * Gets permissions
     *
     * @return \OpenAPI\Client\Model\PersonPermissionType[]
     */
     ...
     * Sets permissions
     *
     * @param \OpenAPI\Client\Model\PersonPermissionType[] $permissions Lista nadawanych uprawnień. Każda wartość może wystąpić tylko raz.
     *
     * @return self
     */
